...
<body>
    ...
    <div class="navbar navbar-expand-lg bg-light navbar-light">
        <div class="container-fluid">
            <a href="index.html" class="navbar-brand"><?= $titulo1 ?> <span><?= $titulo2 ?></span></a>
                        ...
                        <form action="" method="POST">
                            <div class="control-group">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Name" name="nombre" required="required" />
                            ...
                            <div class="control-group">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Mobile" name="telefono" required="required" />
                                    <div class="input-group-append">
                            ...
                            <div class="control-group">
                                <div class="input-group date" id="date" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" name="fecha" placeholder="Date" data-target="#date" data-toggle="datetimepicker" />
                            ...
                            <div class="control-group">
                                <div class="input-group time" id="time" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" name="hora" placeholder="Time" data-target="#time" data-toggle="datetimepicker" />
                            ...
                            <div class="control-group">
                                <div class="input-group">
                                    <select class="custom-select form-control" name="invitados">
                            ...
                            <div>
                                <button class="btn custom-btn" name="reservar" type="submit">Book Now</button>
                            </div>
                            <?php
                            if (isset($_POST["reservar"])) {
                            ?>
